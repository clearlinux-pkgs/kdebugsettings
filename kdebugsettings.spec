...
Source0  : https://download.kde.org/stable/release-service/22.08.3/src/kdebugsettings-22.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.3/src/kdebugsettings-22.08.3.tar.xz.sig
...
%prep
%setup -q -n kdebugsettings-22.08.3
cd %{_builddir}/kdebugsettings-22.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667881970
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libkdebugsettings.so.22.08.3
