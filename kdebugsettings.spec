...
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/kdebugsettings-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/kdebugsettings-24.08.0.tar.xz.sig
...
%setup -q -n kdebugsettings-24.08.0
cd %{_builddir}/kdebugsettings-24.08.0
pushd ..
cp -a kdebugsettings-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724644520
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdebugsettings.so.24.08.0
/V3/usr/lib64/libkdebugsettingscore.so.24.08.0
/usr/lib64/libkdebugsettings.so.24.08.0
/usr/lib64/libkdebugsettings.so.6
/usr/lib64/libkdebugsettingscore.so.24.08.0
