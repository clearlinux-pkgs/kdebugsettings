...
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/kdebugsettings-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/kdebugsettings-25.04.2.tar.xz.sig
...
%setup -q -n kdebugsettings-25.04.2
cd %{_builddir}/kdebugsettings-25.04.2
pushd ..
cp -a kdebugsettings-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749516299
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdebugsettings.so.25.04.2
/V3/usr/lib64/libkdebugsettingscore.so.25.04.2
/usr/lib64/libkdebugsettings.so.25.04.2
/usr/lib64/libkdebugsettings.so.6
/usr/lib64/libkdebugsettingscore.so.25.04.2
