...
Version  : 22.08.0
Release  : 43
URL      : https://download.kde.org/stable/release-service/22.08.0/src/kdebugsettings-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kdebugsettings-22.08.0.tar.xz
...
%prep
%setup -q -n kdebugsettings-22.08.0
cd %{_builddir}/kdebugsettings-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661550672
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libkdebugsettings.so.22.08.0
