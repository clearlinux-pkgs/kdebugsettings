...
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/kdebugsettings-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/kdebugsettings-23.04.0.tar.xz.sig
...
%prep
%setup -q -n kdebugsettings-23.04.0
cd %{_builddir}/kdebugsettings-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682092508
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libkdebugsettings.so.23.04.0
