...
Version  : 22.04.3
Release  : 42
URL      : https://download.kde.org/stable/release-service/22.04.3/src/kdebugsettings-22.04.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.3/src/kdebugsettings-22.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.3/src/kdebugsettings-22.04.3.tar.xz.sig
...
%prep
%setup -q -n kdebugsettings-22.04.3
cd %{_builddir}/kdebugsettings-22.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657576360
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdebugsettings-22.04.3/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kdebugsettings/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/kdebugsettings-22.04.3/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kdebugsettings/f1946dab78e58c04c8c25ec6b074f5fc5c2830fe
cp %{_builddir}/kdebugsettings-22.04.3/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kdebugsettings/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/kdebugsettings-22.04.3/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdebugsettings/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/kdebugsettings-22.04.3/src/org.kde.kdebugsettings.desktop.license %{buildroot}/usr/share/package-licenses/kdebugsettings/864bc0eb28c73bd997ac19ff91935ab771846615
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libkdebugsettings.so.22.04.3
