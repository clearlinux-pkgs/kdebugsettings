...
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/kdebugsettings-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/kdebugsettings-25.04.0.tar.xz.sig
...
%setup -q -n kdebugsettings-25.04.0
cd %{_builddir}/kdebugsettings-25.04.0
pushd ..
cp -a kdebugsettings-25.04.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744936912
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdebugsettings.so.25.04.0
/V3/usr/lib64/libkdebugsettingscore.so.25.04.0
/usr/lib64/libkdebugsettings.so.25.04.0
/usr/lib64/libkdebugsettings.so.6
/usr/lib64/libkdebugsettingscore.so.25.04.0
