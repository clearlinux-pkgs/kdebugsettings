...
Source0  : https://download.kde.org/stable/release-service/20.12.0/src/kdebugsettings-20.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.0/src/kdebugsettings-20.12.0.tar.xz.sig
...
%prep
%setup -q -n kdebugsettings-20.12.0
cd %{_builddir}/kdebugsettings-20.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607713381
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdebugsettings-20.12.0/COPYING %{buildroot}/usr/share/package-licenses/kdebugsettings/ba8966e2473a9969bdcab3dc82274c817cfd98a1
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libkdebugsettings.so.20.12.0
